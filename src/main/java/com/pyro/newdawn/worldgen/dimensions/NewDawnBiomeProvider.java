...
public class NewDawnBiomeProvider extends BiomeSource {
    public static final Codec<NewDawnBiomeProvider> CODEC = RegistryOps.retrieveRegistry(Registry.BIOME_REGISTRY)
            .xmap(NewDawnBiomeProvider::new, NewDawnBiomeProvider::getBiomeRegistry).codec();

    private final Holder<Biome> biome;
    private final Registry<Biome> biomeRegistry;
    private static final List<ResourceKey<Biome>> SPAWN = Collections.singletonList(Biomes.PLAINS);

    public NewDawnBiomeProvider(Registry<Biome> biomeRegistry) {
